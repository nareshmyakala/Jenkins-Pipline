...
#else
#define _AC                ((Ac       *)0x42002000UL) /**< \brief (AC) APB Base Address */
#define _AC_INST_NUM       1                          /**< \brief (AC) Number of instances */
#define _AC_INSTS          { AC }                     /**< \brief (AC) Instances List */

#define _ADC0              ((Adc      *)0x43001C00UL) /**< \brief (ADC0) APB Base Address */
#define _ADC1              ((Adc      *)0x43002000UL) /**< \brief (ADC1) APB Base Address */
#define _ADC_INST_NUM      2                          /**< \brief (ADC) Number of instances */
#define _ADC_INSTS         { ADC0, ADC1 }             /**< \brief (ADC) Instances List */

#define _AES               ((Aes      *)0x42002400UL) /**< \brief (AES) APB Base Address */
#define _AES_INST_NUM      1                          /**< \brief (AES) Number of instances */
#define _AES_INSTS         { AES }                    /**< \brief (AES) Instances List */

#define _CAN0              ((Can      *)0x42000000UL) /**< \brief (CAN0) APB Base Address */
#define _CAN1              ((Can      *)0x42000400UL) /**< \brief (CAN1) APB Base Address */
#define _CAN_INST_NUM      2                          /**< \brief (CAN) Number of instances */
#define _CAN_INSTS         { CAN0, CAN1 }             /**< \brief (CAN) Instances List */

#define _CCL               ((Ccl      *)0x42003800UL) /**< \brief (CCL) APB Base Address */
#define _CCL_INST_NUM      1                          /**< \brief (CCL) Number of instances */
#define _CCL_INSTS         { CCL }                    /**< \brief (CCL) Instances List */

#define _CMCC              ((Cmcc     *)0x41006000UL) /**< \brief (CMCC) APB Base Address */
#define _CMCC_AHB                      (0x03000000UL) /**< \brief (CMCC) AHB Base Address */
#define _CMCC_INST_NUM     1                          /**< \brief (CMCC) Number of instances */
#define _CMCC_INSTS        { CMCC }                   /**< \brief (CMCC) Instances List */

#define _DAC               ((Dac      *)0x43002400UL) /**< \brief (DAC) APB Base Address */
#define _DAC_INST_NUM      1                          /**< \brief (DAC) Number of instances */
#define _DAC_INSTS         { DAC }                    /**< \brief (DAC) Instances List */

#define _DMAC              ((Dmac     *)0x4100A000UL) /**< \brief (DMAC) APB Base Address */
#define _DMAC_INST_NUM     1                          /**< \brief (DMAC) Number of instances */
#define _DMAC_INSTS        { DMAC }                   /**< \brief (DMAC) Instances List */

#define _DSU               ((Dsu      *)0x41002000UL) /**< \brief (DSU) APB Base Address */
#define _DSU_INST_NUM      1                          /**< \brief (DSU) Number of instances */
#define _DSU_INSTS         { DSU }                    /**< \brief (DSU) Instances List */

#define _EIC               ((Eic      *)0x40002800UL) /**< \brief (EIC) APB Base Address */
#define _EIC_INST_NUM      1                          /**< \brief (EIC) Number of instances */
#define _EIC_INSTS         { EIC }                    /**< \brief (EIC) Instances List */

#define _EVSYS             ((Evsys    *)0x4100E000UL) /**< \brief (EVSYS) APB Base Address */
#define _EVSYS_INST_NUM    1                          /**< \brief (EVSYS) Number of instances */
#define _EVSYS_INSTS       { EVSYS }                  /**< \brief (EVSYS) Instances List */

#define _FREQM             ((Freqm    *)0x40002C00UL) /**< \brief (FREQM) APB Base Address */
#define _FREQM_INST_NUM    1                          /**< \brief (FREQM) Number of instances */
#define _FREQM_INSTS       { FREQM }                  /**< \brief (FREQM) Instances List */

#define _GCLK              ((Gclk     *)0x40001C00UL) /**< \brief (GCLK) APB Base Address */
#define _GCLK_INST_NUM     1                          /**< \brief (GCLK) Number of instances */
#define _GCLK_INSTS        { GCLK }                   /**< \brief (GCLK) Instances List */

#define _HMATRIX           ((Hmatrixb *)0x4100C000UL) /**< \brief (HMATRIX) APB Base Address */
#define _HMATRIXB_INST_NUM 1                          /**< \brief (HMATRIXB) Number of instances */
#define _HMATRIXB_INSTS    { HMATRIX }                /**< \brief (HMATRIXB) Instances List */

#define _ICM               ((Icm      *)0x42002C00UL) /**< \brief (ICM) APB Base Address */
#define _ICM_INST_NUM      1                          /**< \brief (ICM) Number of instances */
#define _ICM_INSTS         { ICM }                    /**< \brief (ICM) Instances List */

#define _I2S               ((I2s      *)0x43002800UL) /**< \brief (I2S) APB Base Address */
#define _I2S_INST_NUM      1                          /**< \brief (I2S) Number of instances */
#define _I2S_INSTS         { I2S }                    /**< \brief (I2S) Instances List */

#define _MCLK              ((Mclk     *)0x40000800UL) /**< \brief (MCLK) APB Base Address */
#define _MCLK_INST_NUM     1                          /**< \brief (MCLK) Number of instances */
#define _MCLK_INSTS        { MCLK }                   /**< \brief (MCLK) Instances List */

#define _NVMCTRL           ((Nvmctrl  *)0x41004000UL) /**< \brief (NVMCTRL) APB Base Address */
#define _NVMCTRL_CB                    (0x00800000UL) /**< \brief (NVMCTRL) CB Base Address */
#define _NVMCTRL_CBW0                  (0x00800000UL) /**< \brief (NVMCTRL) CBW0 Base Address */
#define _NVMCTRL_CBW1                  (0x00800010UL) /**< \brief (NVMCTRL) CBW1 Base Address */
#define _NVMCTRL_CBW2                  (0x00800020UL) /**< \brief (NVMCTRL) CBW2 Base Address */
#define _NVMCTRL_CBW3                  (0x00800030UL) /**< \brief (NVMCTRL) CBW3 Base Address */
#define _NVMCTRL_CBW4                  (0x00800040UL) /**< \brief (NVMCTRL) CBW4 Base Address */
#define _NVMCTRL_CBW5                  (0x00800050UL) /**< \brief (NVMCTRL) CBW5 Base Address */
#define _NVMCTRL_CBW6                  (0x00800060UL) /**< \brief (NVMCTRL) CBW6 Base Address */
#define _NVMCTRL_CBW7                  (0x00800070UL) /**< \brief (NVMCTRL) CBW7 Base Address */
#define _NVMCTRL_FS                    (0x00806000UL) /**< \brief (NVMCTRL) FS Base Address */
#define _NVMCTRL_SW0                   (0x00800080UL) /**< \brief (NVMCTRL) SW0 Base Address */
#define _NVMCTRL_SW1                   (0x00800090UL) /**< \brief (NVMCTRL) SW1 Base Address */
#define _NVMCTRL_SW2                   (0x008000A0UL) /**< \brief (NVMCTRL) SW2 Base Address */
#define _NVMCTRL_SW3                   (0x008000B0UL) /**< \brief (NVMCTRL) SW3 Base Address */
#define _NVMCTRL_SW4                   (0x008000C0UL) /**< \brief (NVMCTRL) SW4 Base Address */
#define _NVMCTRL_SW5                   (0x008000D0UL) /**< \brief (NVMCTRL) SW5 Base Address */
#define _NVMCTRL_SW6                   (0x008000E0UL) /**< \brief (NVMCTRL) SW6 Base Address */
#define _NVMCTRL_SW7                   (0x008000F0UL) /**< \brief (NVMCTRL) SW7 Base Address */
#define _NVMCTRL_TEMP_LOG_W0           (0x00800100UL) /**< \brief (NVMCTRL) TEMP_LOG_W0 Base Address */
#define _NVMCTRL_TEMP_LOG_W1           (0x00800110UL) /**< \brief (NVMCTRL) TEMP_LOG_W1 Base Address */
#define _NVMCTRL_TEMP_LOG_W2           (0x00800120UL) /**< \brief (NVMCTRL) TEMP_LOG_W2 Base Address */
#define _NVMCTRL_TEMP_LOG_W3           (0x00800130UL) /**< \brief (NVMCTRL) TEMP_LOG_W3 Base Address */
#define _NVMCTRL_TEMP_LOG_W4           (0x00800140UL) /**< \brief (NVMCTRL) TEMP_LOG_W4 Base Address */
#define _NVMCTRL_TEMP_LOG_W5           (0x00800150UL) /**< \brief (NVMCTRL) TEMP_LOG_W5 Base Address */
#define _NVMCTRL_TEMP_LOG_W6           (0x00800160UL) /**< \brief (NVMCTRL) TEMP_LOG_W6 Base Address */
#define _NVMCTRL_TEMP_LOG_W7           (0x00800170UL) /**< \brief (NVMCTRL) TEMP_LOG_W7 Base Address */
#define _NVMCTRL_TLATCH                (0x00802000UL) /**< \brief (NVMCTRL) TLATCH Base Address */
#define _NVMCTRL_USER                  (0x00804000UL) /**< \brief (NVMCTRL) USER Base Address */
#define _NVMCTRL_INST_NUM  1                          /**< \brief (NVMCTRL) Number of instances */
#define _NVMCTRL_INSTS     { NVMCTRL }                /**< \brief (NVMCTRL) Instances List */

#define _OSCCTRL           ((Oscctrl  *)0x40001000UL) /**< \brief (OSCCTRL) APB Base Address */
#define _OSCCTRL_INST_NUM  1                          /**< \brief (OSCCTRL) Number of instances */
#define _OSCCTRL_INSTS     { OSCCTRL }                /**< \brief (OSCCTRL) Instances List */

#define _OSC32KCTRL        ((Osc32kctrl *)0x40001400UL) /**< \brief (OSC32KCTRL) APB Base Address */
#define _OSC32KCTRL_INST_NUM 1                          /**< \brief (OSC32KCTRL) Number of instances */
#define _OSC32KCTRL_INSTS  { OSC32KCTRL }             /**< \brief (OSC32KCTRL) Instances List */

#define _PAC               ((Pac      *)0x40000000UL) /**< \brief (PAC) APB Base Address */
#define _PAC_INST_NUM      1                          /**< \brief (PAC) Number of instances */
#define _PAC_INSTS         { PAC }                    /**< \brief (PAC) Instances List */

#define _PCC               ((Pcc      *)0x43002C00UL) /**< \brief (PCC) APB Base Address */
#define _PCC_INST_NUM      1                          /**< \brief (PCC) Number of instances */
#define _PCC_INSTS         { PCC }                    /**< \brief (PCC) Instances List */

#define _PDEC              ((Pdec     *)0x42001C00UL) /**< \brief (PDEC) APB Base Address */
#define _PDEC_INST_NUM     1                          /**< \brief (PDEC) Number of instances */
#define _PDEC_INSTS        { PDEC }                   /**< \brief (PDEC) Instances List */

#define _PM                ((Pm       *)0x40000400UL) /**< \brief (PM) APB Base Address */
#define _PM_INST_NUM       1                          /**< \brief (PM) Number of instances */
#define _PM_INSTS          { PM }                     /**< \brief (PM) Instances List */

#define _PORT              ((Port     *)0x41008000UL) /**< \brief (PORT) APB Base Address */
#define _PORT_INST_NUM     1                          /**< \brief (PORT) Number of instances */
#define _PORT_INSTS        { PORT }                   /**< \brief (PORT) Instances List */

#define _PUKCC             ((void     *)0x42003000UL) /**< \brief (PUKCC) APB Base Address */
#define _PUKCC_AHB         ((void     *)0x02000000UL) /**< \brief (PUKCC) AHB Base Address */
#define _PUKCC_INST_NUM    1                          /**< \brief (PUKCC) Number of instances */
#define _PUKCC_INSTS       { PUKCC }                  /**< \brief (PUKCC) Instances List */

#define _QSPI              ((Qspi     *)0x42003400UL) /**< \brief (QSPI) APB Base Address */
#define _QSPI_AHB                      (0x04000000UL) /**< \brief (QSPI) AHB Base Address */
#define _QSPI_INST_NUM     1                          /**< \brief (QSPI) Number of instances */
#define _QSPI_INSTS        { QSPI }                   /**< \brief (QSPI) Instances List */

#define _RAMECC            ((Ramecc   *)0x41020000UL) /**< \brief (RAMECC) APB Base Address */
#define _RAMECC_INST_NUM   1                          /**< \brief (RAMECC) Number of instances */
#define _RAMECC_INSTS      { RAMECC }                 /**< \brief (RAMECC) Instances List */

#define _RSTC              ((Rstc     *)0x40000C00UL) /**< \brief (RSTC) APB Base Address */
#define _RSTC_INST_NUM     1                          /**< \brief (RSTC) Number of instances */
#define _RSTC_INSTS        { RSTC }                   /**< \brief (RSTC) Instances List */

#define _RTC               ((Rtc      *)0x40002400UL) /**< \brief (RTC) APB Base Address */
#define _RTC_INST_NUM      1                          /**< \brief (RTC) Number of instances */
#define _RTC_INSTS         { RTC }                    /**< \brief (RTC) Instances List */

#define _SDHC0             ((Sdhc     *)0x45000000UL) /**< \brief (SDHC0) AHB Base Address */
#define _SDHC_INST_NUM     1                          /**< \brief (SDHC) Number of instances */
#define _SDHC_INSTS        { SDHC0 }                  /**< \brief (SDHC) Instances List */

#define _SERCOM0           ((Sercom   *)0x40003000UL) /**< \brief (SERCOM0) APB Base Address */
#define _SERCOM1           ((Sercom   *)0x40003400UL) /**< \brief (SERCOM1) APB Base Address */
#define _SERCOM2           ((Sercom   *)0x41012000UL) /**< \brief (SERCOM2) APB Base Address */
#define _SERCOM3           ((Sercom   *)0x41014000UL) /**< \brief (SERCOM3) APB Base Address */
#define _SERCOM4           ((Sercom   *)0x43000000UL) /**< \brief (SERCOM4) APB Base Address */
#define _SERCOM5           ((Sercom   *)0x43000400UL) /**< \brief (SERCOM5) APB Base Address */
#define _SERCOM_INST_NUM   6                          /**< \brief (SERCOM) Number of instances */
#define _SERCOM_INSTS      { SERCOM0, SERCOM1, SERCOM2, SERCOM3, SERCOM4, SERCOM5 } /**< \brief (SERCOM) Instances List */

#define _SUPC              ((Supc     *)0x40001800UL) /**< \brief (SUPC) APB Base Address */
#define _SUPC_INST_NUM     1                          /**< \brief (SUPC) Number of instances */
#define _SUPC_INSTS        { SUPC }                   /**< \brief (SUPC) Instances List */

#define _TAL               ((Tal      *)0x4101E000UL) /**< \brief (TAL) APB Base Address */
#define _TAL_INST_NUM      1                          /**< \brief (TAL) Number of instances */
#define _TAL_INSTS         { TAL }                    /**< \brief (TAL) Instances List */

#define _TC0               ((Tc       *)0x40003800UL) /**< \brief (TC0) APB Base Address */
#define _TC1               ((Tc       *)0x40003C00UL) /**< \brief (TC1) APB Base Address */
#define _TC2               ((Tc       *)0x4101A000UL) /**< \brief (TC2) APB Base Address */
#define _TC3               ((Tc       *)0x4101C000UL) /**< \brief (TC3) APB Base Address */
#define _TC4               ((Tc       *)0x42001400UL) /**< \brief (TC4) APB Base Address */
#define _TC5               ((Tc       *)0x42001800UL) /**< \brief (TC5) APB Base Address */
#define _TC_INST_NUM       6                          /**< \brief (TC) Number of instances */
#define _TC_INSTS          { TC0, TC1, TC2, TC3, TC4, TC5 } /**< \brief (TC) Instances List */

#define _TCC0              ((Tcc      *)0x41016000UL) /**< \brief (TCC0) APB Base Address */
#define _TCC1              ((Tcc      *)0x41018000UL) /**< \brief (TCC1) APB Base Address */
#define _TCC2              ((Tcc      *)0x42000C00UL) /**< \brief (TCC2) APB Base Address */
#define _TCC3              ((Tcc      *)0x42001000UL) /**< \brief (TCC3) APB Base Address */
#define _TCC4              ((Tcc      *)0x43001000UL) /**< \brief (TCC4) APB Base Address */
#define _TCC_INST_NUM      5                          /**< \brief (TCC) Number of instances */
#define _TCC_INSTS         { TCC0, TCC1, TCC2, TCC3, TCC4 } /**< \brief (TCC) Instances List */

#define _TRNG              ((Trng     *)0x42002800UL) /**< \brief (TRNG) APB Base Address */
#define _TRNG_INST_NUM     1                          /**< \brief (TRNG) Number of instances */
#define _TRNG_INSTS        { TRNG }                   /**< \brief (TRNG) Instances List */

#define _USB               ((Usb      *)0x41000000UL) /**< \brief (USB) APB Base Address */
#define _USB_INST_NUM      1                          /**< \brief (USB) Number of instances */
#define _USB_INSTS         { USB }                    /**< \brief (USB) Instances List */

#define _WDT               ((Wdt      *)0x40002000UL) /**< \brief (WDT) APB Base Address */
#define _WDT_INST_NUM      1                          /**< \brief (WDT) Number of instances */
#define _WDT_INSTS         { WDT }                    /**< \brief (WDT) Instances List */
